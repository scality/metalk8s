...
import { STATUS_CRITICAL, STATUS_HEALTH, STATUS_NONE, STATUS_WARNING } from '../constants';
import type { AlertLabels, PrometheusAlert } from './alertmanager/api';
...
export const sortAlerts = (alerts: Alert[]): Alert[] => {
  return alerts.sort((a, b) => compareHealth(b.labels.severity, a.labels.severity));
};
...
export const getChildrenAlerts = (jsonPaths: string[], allAlerts: Alert[]) => {
