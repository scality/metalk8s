...
export function queryNodeFSUsage(instanceIP: string): Promise<PrometheusQueryResult> {
...
export function queryNodeFSSize(instanceIP: string): Promise<PrometheusQueryResult> {
...
export function queryPromtheusMetrics(
  ...
  const promPromise = queryPrometheusRange(startingTimeISO, currentTimeISO, frequency, promQuery);
