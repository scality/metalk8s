...
import { PORT_NODE_EXPORTER, STATUS_CRITICAL, STATUS_WARNING } from '../../constants';
...
export const generateQuantileSelectWithKey = (queryName: string, quantile: number) => {
...
const _getPromRangeMatrixQuery = (
  ...
  return {
    queryKey,
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, encodeURIComponent(prometheusQuery));
    },
...
const _getInstantValueQuery = (queryKey: string[], prometheusQuery: string, timestamp: string) => {
  return {
    queryKey,
    queryFn: () => {
...
export const getCPUUsageQuery = (instanceIP: string, timespanProps: TimeSpanProps) => {
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, cpuUsagePrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
    enabled: instanceIP !== '',
...
export const getNodesCPUUsageQuery = (timespanProps: TimeSpanProps) => {
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, cpuNodesUsagePrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
  };
};
export const getNodesCPUUsageQuantileQuery = (timespanProps: TimeSpanProps, quantile: number) => {
  ...
  const query = _getPromRangeMatrixQuery([queryName, String(quantile)], cpuNodesUsagePromQL, timespanProps);
...
export const getNodesCPUUsageOutpassingThresholdQuery = (
  ...
  return {
    ...
    enabled: !!(timestamp && threshold !== undefined && isOnHoverFetchingNeeded),
  };
};
export const getCPUUsageAvgQuery = (timespanProps: TimeSpanProps, showAvg: boolean) => {
  const { startingTimeISO, currentTimeISO, frequency } = timespanProps;
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, cpuUsageAvgPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
    enabled: showAvg,
...
export const getSystemLoadQuery = (instanceIP: string, timespanProps: TimeSpanProps) => {
  const { startingTimeISO, currentTimeISO, frequency } = timespanProps;
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, systemLoadPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
...
export const getSystemLoadAvgQuery = (timespanProps: TimeSpanProps, showAvg: boolean) => {
  const { startingTimeISO, currentTimeISO, frequency } = timespanProps;
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, systemLoadAvgPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
...
export const getMemoryQuery = (instanceIP: string, timespanProps: TimeSpanProps) => {
  const { startingTimeISO, currentTimeISO, frequency } = timespanProps;
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, memoryPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
...
export const getNodesMemoryQuantileQuery = (timespanProps: TimeSpanProps, quantile: number) => {
  ...
  const query = _getPromRangeMatrixQuery([queryName, String(quantile)], nodesMemoryQuantilePromQL, timespanProps);
...
export const getMemoryAvgQuery = (timespanProps: TimeSpanProps, showAvg: boolean) => {
  const { startingTimeISO, currentTimeISO, frequency } = timespanProps;
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, memoryAvgPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
    enabled: showAvg,
...
const getPlaneBandWidthInPromQuery = (instanceIP: string, planeInterface: string) => {
  return `sum(irate(node_network_receive_bytes_total{instance=~"${instanceIP}:${PORT_NODE_EXPORTER}",device="${planeInterface}"}[5m]))`;
};

const getPlaneBandWidthOutPromQuery = (instanceIP: string, planeInterface: string) => {
...
export const getControlPlaneBandWidthAvgInQuery = (
  ...
  for (const nodeIPsInfo of Object.values(nodesIPsInfo)) {
    ...
    if (controlPlaneInterface) {
      nodesCPBandwidthInPrometheusQuery.push(getPlaneBandWidthInPromQuery(instanceIP, controlPlaneInterface));
    }
  }

  const nodeCPBandwithInAvgPrometheusQuery = encodeURIComponent(
    `(${nodesCPBandwidthInPrometheusQuery.join('+')}) / ${nodesCPBandwidthInPrometheusQuery.length}`,
  );
  return {
    queryKey: ['ControlPlaneBandwidthAvgIn', instanceIP, startingTimeISO],
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, nodeCPBandwithInAvgPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
...
export const getControlPlaneBandWidthAvgOutQuery = (
  ...
  for (const nodeIPsInfo of Object.values(nodesIPsInfo)) {
    ...
    if (controlPlaneInterface) {
      nodesCPBandwidthOutPrometheusQuery.push(getPlaneBandWidthOutPromQuery(instanceIP, controlPlaneInterface));
    }
  }

  const nodeCPBandwithAvgOutPrometheusQuery = encodeURIComponent(
    `(${nodesCPBandwidthOutPrometheusQuery.join('+')}) / ${nodesCPBandwidthOutPrometheusQuery.length}`,
  );
  return {
    queryKey: ['ControlPlaneBandwidthAvgOut', instanceIP, startingTimeISO],
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, nodeCPBandwithAvgOutPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
    enabled: !!(showAvg && Object.keys(nodesIPsInfo).length),
...
export const getWorkloadPlaneBandWidthAvgInQuery = (
  ...
  for (const nodeIPsInfo of Object.values(nodesIPsInfo)) {
    ...
    if (workloadPlaneInterface) {
      nodesWPBandwidthInPrometheusQuery.push(getPlaneBandWidthInPromQuery(instanceIP, workloadPlaneInterface));
    }
  }

  const nodeWPBandwithInAvgPrometheusQuery = encodeURIComponent(
    `(${nodesWPBandwidthInPrometheusQuery.join('+')}) / ${nodesWPBandwidthInPrometheusQuery.length}`,
  );
  return {
    queryKey: ['WorkloadPlaneBandwidthAvgIn', instanceIP, startingTimeISO],
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, nodeWPBandwithInAvgPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
    enabled: !!(showAvg && Object.keys(nodesIPsInfo).length),
...
export const getWorkloadPlaneBandWidthAvgOutQuery = (
  ...
  for (const nodeIPsInfo of Object.values(nodesIPsInfo)) {
    ...
    if (controlPlaneInterface) {
      nodesWPBandwidthOutPrometheusQuery.push(getPlaneBandWidthOutPromQuery(instanceIP, controlPlaneInterface));
    }
  }

  const nodeWPBandwithAvgOutPrometheusQuery = encodeURIComponent(
    `(${nodesWPBandwidthOutPrometheusQuery.join('+')}) / ${nodesWPBandwidthOutPrometheusQuery.length}`,
  );
  return {
    queryKey: ['WorkloadPlaneBandwidthAvgOut', instanceIP, startingTimeISO],
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, nodeWPBandwithAvgOutPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
    enabled: !!(showAvg && Object.keys(nodesIPsInfo).length),
...
export const getNodesPlanesBandwidthInQuery = (timespanProps, devices: string[]) => {
  const nodesPlanesBandwidthInQuery = `avg(irate(node_network_receive_bytes_total{device=~"${devices.join(
    '|',
  )}"}[5m])) by (instance,device)`;
  return {
    ..._getPromRangeMatrixQuery(['NodesPlanesBandwidthIn', ...devices], nodesPlanesBandwidthInQuery, timespanProps),
    enabled: !!devices?.length,
  };
};
export const getNodesPlanesBandwidthOutQuery = (timespanProps, devices: string[]) => {
  const nodePlanesBandwidthOutQuery = `avg(irate(node_network_transmit_bytes_total{device=~"${devices.join(
    '|',
  )}"}[5m])) by (instance,device)`;
  return {
    ..._getPromRangeMatrixQuery(['NodesPlanesBandwidthOut', ...devices], nodePlanesBandwidthOutQuery, timespanProps),
    enabled: !!devices?.length,
  };
};
export const getNodesPlanesBandwidthInQuantileQuery = (timespanProps, quantile: number, devices: string[]) => {
...
export const getNodesPlanesBandwidthOutQuantileQuery = (timespanProps, quantile: number, devices: string[]) => {
...
export const getIOPSWriteQuery = (instanceIP: string, timespanProps: TimeSpanProps) => {
  const { startingTimeISO, currentTimeISO, frequency } = timespanProps;
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, iopsWritePrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
...
export const getIOPSReadQuery = (instanceIP: string, timespanProps: TimeSpanProps) => {
  const { startingTimeISO, currentTimeISO, frequency } = timespanProps;
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, iopsReadPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
...
// IOPS Write Average (+)
export const getIOPSWriteAvgQuery = (timespanProps: TimeSpanProps, showAvg: boolean) => {
  const { startingTimeISO, currentTimeISO, frequency } = timespanProps;
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, iopsWriteAvgPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
    enabled: showAvg,
...
// IOPS Read Average (-)
export const getIOPSReadAvgQuery = (timespanProps: TimeSpanProps, showAvg: boolean) => {
  const { startingTimeISO, currentTimeISO, frequency } = timespanProps;
  ...
  return {
    ...
    queryFn: () => {
      return queryPromtheusMetrics(frequency, startingTimeISO, currentTimeISO, iopsReadAvgPrometheusQuery);
    },
    refetchOnMount: false,
    refetchOnWindowFocus: false,
    enabled: showAvg,
...
export const getVolumeUsageQuery = (pvcName: string, namespace: string, timespanProps: TimeSpanProps) => {
  ...
  return _getPromRangeMatrixQuery(['volumeUsage', pvcName, namespace], volumeUsageQuery, timespanProps);
};

const getNodeDevicePrometheusFilter = (instanceIp: string, deviceName: string) => {
  return `{instance="${instanceIp}:${PORT_NODE_EXPORTER}",device="${deviceName}"}`;
};

export const getVolumeThroughputReadQuery = (instanceIp: string, deviceName: string, timespanProps: TimeSpanProps) => {
  const prometheusFilters = getNodeDevicePrometheusFilter(instanceIp, deviceName);
...
export const getVolumeThroughputWriteQuery = (instanceIp: string, deviceName: string, timespanProps: TimeSpanProps) => {
  const prometheusFilters = getNodeDevicePrometheusFilter(instanceIp, deviceName);
...
export const getNodesThroughputReadQuery = (timespanProps: TimeSpanProps) => {
  ...
  return _getPromRangeMatrixQuery(['NodesThroughputReadQuery'], nodesThroughputReadQuery, timespanProps);
};
export const getNodesThroughputWriteQuery = (timespanProps: TimeSpanProps) => {
  ...
  return _getPromRangeMatrixQuery(['NodesThroughputWriteQuery'], nodesThroughputWriteQuery, timespanProps);
};
export const getNodesThroughputWriteQuantileQuery = (timespanProps: TimeSpanProps, quantile: number) => {
  ...
  const query = _getPromRangeMatrixQuery([queryName, `${quantile}`], nodesThroughputWritePromQL, timespanProps);
...
export const getNodesThroughputReadQuantileQuery = (timespanProps: TimeSpanProps, quantile: number) => {
  ...
  const query = _getPromRangeMatrixQuery([queryName, `${quantile}`], nodesThroughputReadPromQL, timespanProps);
...
export const getVolumeIOPSReadQuery = (instanceIp: string, deviceName: string, timespanProps: TimeSpanProps) => {
  const prometheusFilters = getNodeDevicePrometheusFilter(instanceIp, deviceName);
  const volumeIOPSReadQuery = `sum(irate(node_disk_reads_completed_total${prometheusFilters}[5m]))`;
  return _getPromRangeMatrixQuery(['volumeIOPSRead', instanceIp, deviceName], volumeIOPSReadQuery, timespanProps);
};
export const getVolumeIOPSWriteQuery = (instanceIp: string, deviceName: string, timespanProps: TimeSpanProps) => {
  const prometheusFilters = getNodeDevicePrometheusFilter(instanceIp, deviceName);
  const volumeIOPSWriteQuery = `sum(irate(node_disk_writes_completed_total${prometheusFilters}[5m]))`;
  return _getPromRangeMatrixQuery(['volumeIOPSWrite', instanceIp, deviceName], volumeIOPSWriteQuery, timespanProps);
};
export const getVolumeLatencyWriteQuery = (instanceIp: string, deviceName: string, timespanProps: TimeSpanProps) => {
  const prometheusFilters = getNodeDevicePrometheusFilter(instanceIp, deviceName);
...
export const getVolumeLatencyReadQuery = (instanceIp: string, deviceName: string, timespanProps: TimeSpanProps) => {
  const prometheusFilters = getNodeDevicePrometheusFilter(instanceIp, deviceName);
  ...
  return _getPromRangeMatrixQuery(['volumeLatencyRead', instanceIp, deviceName], volumeLatencyReadQuery, timespanProps);
};
// which may cause performance issue
export const getAlertsHistoryQuery = ({ startingTimeISO, currentTimeISO, frequency }: TimeSpanProps) => {
  ...
  return {
    ...
    queryFn: () => {
      return Promise.all([getFormattedLokiAlert(startingTimeISO, currentTimeISO), alertManagerDowntimePromise]).then(
        ([alerts, downTimes]) => {
          const rawAlerts = [
            ...alerts.map((alert) => {
              if (alert.endsAt === null) {
                const endsAtSegment = downTimes.find((downTime) => downTime.startsAt > alert.startsAt) || {
          ...
          rawAlerts.sort((alertA, alertB) => (alertB.startsAt > alertA.startsAt ? -1 : 1));
          return rawAlerts;
        },
      );
    },
...
function convertSegmentToAlert(segment) {
  const baseSegment = {
    startsAt: new Date(segment.startsAt * 1000).toISOString(),
    endsAt: segment.endsAt ? new Date(segment.endsAt * 1000).toISOString() : new Date().toISOString(),
...
export const getClusterAlertSegmentQuery = (duration: number) => {
  ...
  const clusterAlertNumberPromise = ({ startingTimeISO, currentTimeISO, frequency }: TimeSpanProps) =>
    queryPrometheusRange(startingTimeISO, currentTimeISO, frequency, encodeURIComponent(query))?.then((resolve) => {
      if (resolve.status === 'error') {
        throw resolve.error;
      }
      ...
      const clusterAtRiskResult = resolve.data.result.find((result) => result.metric.alertname === 'ClusterAtRisk') || {
        values: [],
      };
      ...
      const watchdogResult = resolve.data.result.find((result) => result.metric.alertname === 'Watchdog') || {
        values: [],
      };
