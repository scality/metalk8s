...
import { addJobAction, allJobsSelector, CONNECT_SALT_API, JOB_COMPLETED } from './salt';
...
export const stopRefreshNodesAction = () => {
  return {
    type: STOP_REFRESH_NODES,
  };
};
export const updateNodesIPsInterfacesAction = (payload) => {
  return {
    type: UPDATE_NODES_IPS_INTERFACES,
    payload,
  };
};
