...
declare function Table<DATA_ROW extends Record<string, unknown> = Record<string, unknown>>({ columns, data, defaultSortingKey, getRowId, children, sortTypes, globalFilter, allFilters, onBottom, onBottomOffset, initiallySelectedRowsIds, updateTableData, status, entityName, }: TableProps<DATA_ROW>): import("react/jsx-runtime").JSX.Element;
declare namespace Table {
    ...
    var MultiSelectableContent: <DATA_ROW extends Record<string, unknown> = Record<string, unknown>>({ onMultiSelectionChanged, onSingleRowSelected, onToggleAll, rowHeight, separationLineVariant, locale, customItemKey, isLoadingMoreItems, children, }: {
        ...
        rowHeight?: TableHeightKeyType;
        separationLineVariant?: import("./TableUtils").TableVariantType;
        locale?: import("./TableUtils").TableLocalType;
