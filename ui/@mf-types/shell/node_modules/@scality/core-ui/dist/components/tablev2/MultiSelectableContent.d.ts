 ...
 */
export declare const MultiSelectableContent: <DATA_ROW extends Record<string, unknown> = Record<string, unknown>>({ onMultiSelectionChanged, onSingleRowSelected, onToggleAll, rowHeight, separationLineVariant, locale, customItemKey, isLoadingMoreItems, children, }: MultiSelectableContentProps<DATA_ROW>) => import("react/jsx-runtime").JSX.Element;
export {};
