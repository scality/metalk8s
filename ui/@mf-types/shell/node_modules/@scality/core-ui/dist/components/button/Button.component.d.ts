...
type Props = {
    text?: string;
    size?: Size;
    variant?: 'buttonPrimary' | 'buttonSecondary' | 'buttonDelete' | 'backgroundLevel1';
    outlined?: boolean;
    inverted?: boolean;
    disabled?: boolean;
    icon?: JSX.Element;
...
export declare const ButtonStyled: import("styled-components").StyledComponent<"button", import("styled-components").DefaultTheme, {}, never>;
export declare const ButtonIcon: import("styled-components").StyledComponent<"span", import("styled-components").DefaultTheme, {}, never>;
