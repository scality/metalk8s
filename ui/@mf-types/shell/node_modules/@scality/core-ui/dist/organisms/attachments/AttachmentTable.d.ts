...
export declare const AttachmentProvider: <ENTITY_TYPE extends unknown, ENTITY extends Record<string, unknown> = Record<string, unknown>>({ children, }: PropsWithChildren<{}>) => import("react/jsx-runtime").JSX.Element;
export declare const useAttachmentOperations: () => {
    resetAttachmentTable: (initiallyAttachedEntities: AttachableEntity<any, any>[], //Deliberately using any here because we can't use generics
    initialAttachmentOperations: AttachmentOperation<any, any>[]) => void;
};
export declare const AttachmentTable: <ENTITY_TYPE, ENTITY extends Record<string, unknown> = Record<string, unknown>>({ initiallyAttachedEntities, initiallyAttachedEntitiesStatus, initialAttachmentOperations, onAttachmentsOperationsChanged, entityName, searchEntityPlaceholder, getNameQuery, filteredEntities, onEntitySearchChange, }: AttachmentTableProps<ENTITY_TYPE, ENTITY>) => import("react/jsx-runtime").JSX.Element;
