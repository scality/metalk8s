...
type ObjectHandler struct {
	// The ClusterConfig Instance used as Owner reference on every objects
	Instance *metalk8sv1alpha1.ClusterConfig
...
func NewObjectHandler(instance *metalk8sv1alpha1.ClusterConfig, client client.Client, scheme *runtime.Scheme, logger logr.Logger, component string) *ObjectHandler {
	labels := map[string]string{}
