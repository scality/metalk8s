...
const publish = (dispatch: Dispatch<NotificationCenterActions>) => (notification: Notification) => {
  dispatch({
    type: NotificationActionType.PUBLISH,
    notification: notification,
  });
};
const unPublish = (dispatch: Dispatch<NotificationCenterActions>) => (id: string) => {
  dispatch({ type: NotificationActionType.UNPUBLISH, id: id });
};

const readAllNotifications = (dispatch: Dispatch<NotificationCenterActions>) => () =>
