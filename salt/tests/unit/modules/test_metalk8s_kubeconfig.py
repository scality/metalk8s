...
YAML_TESTS_FILE = os.path.join(
    ...
    "files", "test_metalk8s_kubeconfig.yaml"
)
...
class Metalk8sKubeconfigTestCase(TestCase, mixins.LoaderModuleMockMixin):
    ...
    def test_virtual(self):
        ...
        """
        self.assertEqual(
            metalk8s_kubeconfig.__virtual__(), 'metalk8s_kubeconfig'
        )
    ...
    def test_validate(self,
        ...
        patch_salt_dict = {
            ...
            "x509.verify_signature": MagicMock(
                return_value=verify_signature_result
            ),
