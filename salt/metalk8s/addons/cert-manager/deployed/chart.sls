                        ...
                        properties:
                          nameserver:
                            description: "The IP address or hostname of an authoritative\
                              \ DNS server supporting\nRFC2136 in the form host:port.\
                              ...
                              properties:
                                nameserver:
                                  description: "The IP address or hostname of an authoritative\
                                    \ DNS server supporting\nRFC2136 in the form host:port.\
                                    \ If the host is an IPv6 address it must be\n\
                                    enclosed in square brackets (e.g [2001:db8::1])\_\
                                    ; port is optional.\nThis field is required."
                                  type: string
                                tsigAlgorithm:
                                  description: |-
  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        image: {% endraw -%}{{ build_image_name("cert-manager-cainjector", False) }}{%- raw %}:v1.15.3
  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        - --leader-election-namespace=kube-system
        - --acme-http01-solver-image={% endraw -%}{{ build_image_name("cert-manager-acmesolver", False) }}{%- raw %}:v1.15.3
      ...
      - args:
        ...
        - name: POD_NAMESPACE
          valueFrom:
            fieldRef:
              fieldPath: metadata.namespace
        image: {% endraw -%}{{ build_image_name("cert-manager-webhook", False) }}{%- raw %}:v1.15.3
        imagePullPolicy: IfNotPresent
        livenessProbe:
          failureThreshold: 3
          httpGet:
...
metadata:
  annotations:
    cert-manager.io/inject-ca-from-secret: metalk8s-certs/cert-manager-webhook-ca
  labels:
    app: webhook
    app.kubernetes.io/component: webhook
    app.kubernetes.io/instance: cert-manager
