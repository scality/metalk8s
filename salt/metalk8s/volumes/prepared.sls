...
Skip volume preparation (during bootstrap):
  test.succeed_without_changes: []

{%- elif '_errors' in all_volumes %}

Cannot proceed with volume preparation (errors in pillar):
  test.fail_without_changes:
    - comment: 'Errors: {{ all_volumes._errors | join(", ") }}'
