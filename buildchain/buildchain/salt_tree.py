...
SALT_FILES: Tuple[Union[Path, targets.AtomicTarget], ...] = (
    ...
    Path("salt/metalk8s/kubernetes/cni/cilium/deployed.sls"),
    Path("salt/metalk8s/kubernetes/cni/cilium-configuration/deployed.sls"),
    Path("salt/metalk8s/kubernetes/cni/cilium-crds/deployed.sls"),
    Path("salt/metalk8s/kubernetes/gateway-api-crds/deployed.sls"),
