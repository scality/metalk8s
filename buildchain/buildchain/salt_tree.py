...
SALT_FILES: Tuple[Union[Path, targets.AtomicTarget], ...] = (
    ...
    Path("salt/metalk8s/orchestrate/backup/files/cleanup_job.yaml.j2"),
    Path("salt/metalk8s/orchestrate/backup/cleanup.sls"),
    ...
    Path("salt/_modules/metalk8s_backups.py"),
