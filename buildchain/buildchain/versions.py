...
CERT_MANAGER_VERSION: str = "1.15.0"
...
CONTAINER_IMAGES: Tuple[Image, ...] = (
    ...
    Image(
        ...
        digest="sha256:ac3b6876d95fe7b7691e69f2161a5466adbe9d72d44f342d595674321ce16d23",
    ),
    Image(
        name="kube-controller-manager",
        version=_version_prefix(K8S_VERSION),
        digest="sha256:996c6259e4405ab79083fbb52bcf53003691a50b579862bf29b3abaa468460db",
    ),
    Image(
        name="kube-proxy",
        version=_version_prefix(K8S_VERSION),
        digest="sha256:7dd7829fa889ac805a0b1047eba04599fa5006bdbcb5cb9c8d14e1dc8910488b",
    ),
    Image(
        name="kube-scheduler",
        version=_version_prefix(K8S_VERSION),
        digest="sha256:d93a3b5961248820beb5ec6dfb0320d12c0dba82fc48693d20d345754883551c",
    ),
    Image(
    ...
    Image(
        ...
        version=_version_prefix(CERT_MANAGER_VERSION),
        digest="sha256:d3e33a240db1be4076d1d1766fbaddd8a2dc7533d89b9f85e2b65b5419dd36a9",
    ),
    Image(
    ...
    Image(
        ...
        version=_version_prefix(CERT_MANAGER_VERSION),
        digest="sha256:001ccf30ce45cc214e293b570090e0ac1d22c364cfccc081f22311b28cdbbda8",
    ),
    Image(
