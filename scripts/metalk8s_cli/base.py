"""Base class for generating a CLI with git-style subcommands."""
...
class Command(six.with_metaclass(abc.ABCMeta, object)):
    ...
    # List of defaults to set for this Command's parser (useful for setting
    # different default values for the same parent parser argument)
    DEFAULTS = {}
