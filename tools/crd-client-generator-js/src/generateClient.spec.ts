...
describe('client generator', () => {
    it('should generate expected cluster scoped client given metalk8s volume CRD file', () => {
        const crdFile = path.join(__dirname, './__TESTS__/storage.metalk8s.scality.com_volumes_crd.yaml');
        const destFile = 'TestOutputFile.js';
...
`);
    ...
    it('should generate expected namespaced scoped client given metalk8s volume CRD file', () => {
      const crdFile = path.join(__dirname, './__TESTS__/namespaced_scoped_crd.yaml');
      const destFile = 'TestOutputFile.js';
